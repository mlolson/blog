# How I used Claude code to teach myself Rust
...
## Step 1: Creating a custom Claude plugin to for learning
...
**Weekly coding goal**: Commit history is parsed to produce statistics on how much code I and Claude have written in the past week. I can set a goal for the amount of human commits in the project, and when the ratio falls below that target Claude is blocked from writing code. I configured this so that 25% of commits that must be written by me rather than claude
...
My goal was to learn Rust, and I am very happy with the process that I made. I understand basic syntax. I understand Rust’s system for allocating memory, and its unique way of handling errors. 
...
In drive mode, Claude can do everything except write code. Use it as your own personal coach and mentor. Ask questions about how things work on a fundamental level. Ask questions about syntax. Go deep and get Claude to explain theory and reasons behind things. This is a really powerful 
